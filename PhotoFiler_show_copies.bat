...
@echo on
call :MAKE_FILENAME %LOG_DIR% PhotoFiler _SHOW
CALL :SHOWNOTFULLSIZE_KNOWN
CALL :SHOWNOTFULLSIZE_BRANDED_UNKNOWN
CALL :SHOW_BRANDED_UNKNOWN
CALL :SHOW_UNBRANDED
rem CALL :SHOWINCORRECTFILENAMEPREFIXVSFILETIME
goto :EOF

:SHOWNOTFULLSIZE_KNOWN
SET LOGFILENAME=%tmp_filename%_SHOW_NOTFULLSIZE_KNOWN.txt
.\PhotoFiler\bin\Release\PhotoFiler.exe c:\Users\Jonnie\Downloads -r --ShowKnown   --ShowNotFullsize         >> %LOGFILENAME%
.\PhotoFiler\bin\Release\PhotoFiler.exe c:\Users\Jonnie\Pictures  -r --ShowKnown   --ShowNotFullsize         >> %LOGFILENAME%
.\PhotoFiler\bin\Release\PhotoFiler.exe c:\home\_Photos           -r --ShowKnown   --ShowNotFullsize         >> %LOGFILENAME%
.\PhotoFiler\bin\Release\PhotoFiler.exe d:\home\_Photos           -r --ShowKnown   --ShowNotFullsize         >> %LOGFILENAME%
goto :EOF

:SHOWNOTFULLSIZE_BRANDED_UNKNOWN
SET LOGFILENAME=%tmp_filename%_SHOW_NOTFULLSIZE_BRANDED_UNKNOWN.txt
.\PhotoFiler\bin\Release\PhotoFiler.exe c:\Users\Jonnie\Downloads -r --ShowBranded --ShowUnknown   --ShowNotFullsize         >> %LOGFILENAME%
.\PhotoFiler\bin\Release\PhotoFiler.exe c:\Users\Jonnie\Pictures  -r --ShowBranded --ShowUnknown   --ShowNotFullsize         >> %LOGFILENAME%
.\PhotoFiler\bin\Release\PhotoFiler.exe c:\home\_Photos           -r --ShowBranded --ShowUnknown   --ShowNotFullsize         >> %LOGFILENAME%
.\PhotoFiler\bin\Release\PhotoFiler.exe d:\home\_Photos           -r --ShowBranded --ShowUnknown   --ShowNotFullsize         >> %LOGFILENAME%
goto :EOF

:SHOW_BRANDED_UNKNOWN
SET LOGFILENAME=%tmp_filename%_SHOW_BRANDED_UNKNOWN.txt
.\PhotoFiler\bin\Release\PhotoFiler.exe c:\Users\Jonnie\Downloads -r --ShowBranded --ShowUnknown            >> %LOGFILENAME%
.\PhotoFiler\bin\Release\PhotoFiler.exe c:\Users\Jonnie\Pictures  -r --ShowBranded --ShowUnknown            >> %LOGFILENAME%
.\PhotoFiler\bin\Release\PhotoFiler.exe c:\home\_Photos           -r --ShowBranded --ShowUnknown            >> %LOGFILENAME%
.\PhotoFiler\bin\Release\PhotoFiler.exe d:\home\_Photos           -r --ShowBranded --ShowUnknown            >> %LOGFILENAME%
goto :EOF

:SHOW_UNBRANDED
SET LOGFILENAME=%tmp_filename%_SHOW_UNBRANDED.txt
.\PhotoFiler\bin\Release\PhotoFiler.exe c:\Users\Jonnie\Downloads -r --ShowUnbranded          >> %LOGFILENAME%
.\PhotoFiler\bin\Release\PhotoFiler.exe c:\Users\Jonnie\Pictures  -r --ShowUnbranded          >> %LOGFILENAME%
.\PhotoFiler\bin\Release\PhotoFiler.exe c:\home\_Photos           -r --ShowUnbranded          >> %LOGFILENAME%
.\PhotoFiler\bin\Release\PhotoFiler.exe d:\home\_Photos           -r --ShowUnbranded          >> %LOGFILENAME%
goto :EOF

:SHOWINCORRECTFILENAMEPREFIXVSFILETIME
SET LOGFILENAME=%tmp_filename%:SHOW_INCORRECTFILENAMEPREFIXVSFILETIME.txt
.\PhotoFiler\bin\Release\PhotoFiler.exe c:\Users\Jonnie\Downloads -r --ShowIncorrectFilenamePrefixVsFiletime   >> %LOGFILENAME%
.\PhotoFiler\bin\Release\PhotoFiler.exe c:\Users\Jonnie\Pictures  -r --ShowIncorrectFilenamePrefixVsFiletime   >> %LOGFILENAME%
.\PhotoFiler\bin\Release\PhotoFiler.exe c:\home\_Photos           -r --ShowIncorrectFilenamePrefixVsFiletime   >> %LOGFILENAME%
.\PhotoFiler\bin\Release\PhotoFiler.exe d:\home\_Photos           -r --ShowIncorrectFilenamePrefixVsFiletime   >> %LOGFILENAME%
goto :EOF
...
rem .\PhotoFiler\bin\Release\PhotoFiler.exe %1 -r --ShowKnown --ShowNotFullsize                          >> %LOGFILENAME%
goto :EOF
