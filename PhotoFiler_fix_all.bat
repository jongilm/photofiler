...
@echo on
rem call :MAKE_FILENAME %LOG_DIR% PhotoFiler_SHOW1 .txt
rem SET LOGFILENAME=%tmp_filename%
...
:FIX
.\PhotoFiler\bin\Release\PhotoFiler.exe %1 -r --ShowKnown --ShowSpacesAndHyphens                  --ForceUnderscores              >> %LOGFILENAME%
...
.\PhotoFiler\bin\Release\PhotoFiler.exe %1 -r --ShowKnown --ShowIncorrectFilenamePrefixVsExiftime --FixFilenamePrefixFromExifTime >> %LOGFILENAME%
